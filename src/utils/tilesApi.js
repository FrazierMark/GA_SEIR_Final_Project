...
export function getPngTile(longitude, latitude, zoom) {
    ...
    const tilefromlon = lon2tile(longitude, 13)
    const tilefromlat = lat2tile(latitude, 13)
...
// curl "https://api.mapbox.com/v4/mapbox.terrain-rgb/13/2046/3240.png?access_token=pk.eyJ1IjoiZnJhemllcm1hcmsiLCJhIjoiY2wzOTBhZzJiMDFwejNqbzJyMGs0YmZ5NCJ9.2VB9C63HoxzjCpCmbhga9A" --output test.png