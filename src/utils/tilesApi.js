...
export function getPngTile(longitude, latitude, zoom) {
    ...
    const tilefromlat = lon2tile(latitude, zoom)



    const apiRequestData = [longitude, latitude]
...
// curl "https://api.mapbox.com/v4/mapbox.terrain-rgb/14/1980/4700.png?access_token=pk.eyJ1IjoiZnJhemllcm1hcmsiLCJhIjoiY2wzOTBhZzJiMDFwejNqbzJyMGs0YmZ5NCJ9.2VB9C63HoxzjCpCmbhga9A" --output test.png