...
export const getPngTile = async (longitude, latitude, zoom) => {
    ...
    try {
        imageBlob = (
            await axios.get(
                `https://api.mapbox.com/v4/mapbox.terrain-rgb/15/8186/12962.png?access_token=pk.eyJ1IjoiZnJhemllcm1hcmsiLCJhIjoiY2wzOTBhZzJiMDFwejNqbzJyMGs0YmZ5NCJ9.2VB9C63HoxzjCpCmbhga9A`,
                { responseType: "blob" }
            )
        ).data;
    } catch (err) {
